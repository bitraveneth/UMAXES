...
import { heroBanner, heroSceneImages, siteSlogan } from "@/lib/assets";
...
const slides = [
  ...
  {
    src: heroSceneImages[0],
    alt: "HOOKAMAX in hand beside a leather travel bag",
    kicker: "On the move",
  ...
  {
    src: heroSceneImages[1],
    alt: "HOOKAMAX standing in a skatepark bowl",
    kicker: "80K puffs",
  ...
  {
    src: heroSceneImages[3],
    alt: "First-person hold of HOOKAMAX at a skate ramp",
    kicker: "In hand",
    title: "Grip. Glow. Go.",
  ...
  {
    src: heroSceneImages[4],
    alt: "HOOKAMAX under neon studio lights",
    kicker: "Night mode",
  ...
  {
    src: heroSceneImages[5],
    alt: "HOOKAMAX glowing on a rain-lit city street",
    kicker: "After dark",
  ...
  {
    src: heroSceneImages[6],
    alt: "Evening portrait with HOOKAMAX and velvet styling",
...
export default function HeroProgress() {
  ...
  return (
    ...
    >
      <div
        className="relative mx-auto min-h-[22.5rem] h-[min(68svh,34rem)] w-full max-w-[1680px] overflow-hidden rounded-[1.25rem] bg-black touch-pan-y select-none sm:min-h-[32rem] sm:h-[min(80svh,48rem)] sm:rounded-[2.15rem] md:rounded-[2.5rem]"
      ...
      >
        {slides.map((slide, i) => (
          ...
          >
            <Image
              ...
              className={`object-cover ${slide.object} ${
        ...
        <div
          className={`pointer-events-none absolute inset-0 z-[2] transition-colors duration-700 ${
            active.bright
              ? "bg-gradient-to-t from-black/85 via-black/55 to-black/30 sm:bg-gradient-to-r sm:from-black/75 sm:via-black/40 sm:to-black/10"
              : "bg-gradient-to-t from-black/80 via-black/40 to-black/15 sm:bg-gradient-to-r sm:from-black/65 sm:via-black/20 sm:to-transparent"
          }`}
        />
        ...
        <div className="absolute inset-0 z-[3] flex flex-col justify-end px-5 pb-[4.25rem] pt-6 sm:justify-center sm:px-12 sm:pb-16 sm:pt-8 md:px-16 lg:px-20">
          <div className="w-full max-w-[17.5rem] sm:max-w-[min(100%,34rem)]">
            <p
              key={active.kicker}
              className="mb-2 font-display text-[0.65rem] font-semibold tracking-[0.22em] text-white/75 uppercase sm:mb-3 sm:text-[0.72rem] animate-[hero-copy-in_0.55s_ease-out]"
            >
              {active.kicker}
            </p>
            <h1
