  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto grid max-w-[1400px] items-center gap-10 lg:grid-cols-[minmax(0,1.25fr)_minmax(0,0.95fr)] lg:gap-12 xl:gap-16">
        {/* Left — devices; pills reveal on hover (always on touch / focus) */}
        ...
        {/* Right — Introduction box + big 80K watermark */}
        <div className="relative min-w-0">
          <div
            aria-hidden
            className="pointer-events-none absolute -top-10 right-0 select-none font-display text-[clamp(5.5rem,16vw,9rem)] font-extrabold leading-none tracking-[-0.06em] text-black/[0.05] sm:-top-12"
          >
            80K
          </div>
